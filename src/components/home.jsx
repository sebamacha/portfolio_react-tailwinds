...
<section id="home" className="bg-slate-200 hero dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-lg text-center lg:py-16">
    <div className=" avatar-img flex flex-row justify-center gap-4">
      <img className="w-6 h-6 rounded" src={avatar} alt="Extra small avatar" />
    ...
    <h3
      className="porfolio-digital text-white mb-1 mt-1 text-4xl font-extrabold tracking-tight text- leading-none md:text-5xl lg:text-6xl dark:text-yellow-300"
    >
      Portfolio Digital
    </h3>
  </div>
